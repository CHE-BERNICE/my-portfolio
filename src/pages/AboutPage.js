    ...
    <div className='m-0'>
        ...
        <div className='py-12 px-8 md:px-32'>
            ...
            <section className='border-t-2 border-t-slate-100 pt-5'>
                ...
                <table>
                    <tbody>
                        <tr className='bg-slate-100 px-5'>
                            <td className='px-4'>
                                <div className='h-18 w-40 font-bold text-4xl text-white text-center p-3 py-3 rounded-full bg-blue-300'>2021</div>
                            </td>
                        ...
                        <tr className='bg-slate-200 px-5'>
                            <td className='px-4'>
                                <div className='h-18 w-40 font-bold text-4xl text-white text-center p-3 py-3 rounded-full bg-blue-400'>2022</div>
                            </td>
                            <td className='px-4 py-3'>
                                <ul>
                        ...
                        <tr className='bg-slate-300 px-5'>
                            <td className='px-4'>
                                <div className='h-18 w-40 font-bold text-4xl text-white text-center p-3 py-3 rounded-full bg-blue-500'>2023</div>
                            </td>
                            <td className='px-4 py-3'>
                                <ul>
